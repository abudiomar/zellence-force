...
export const APPLICANT_REVIEW_QUEUE_ITEM_SCHEMA = z.object({
  ...
  canTravel: z.boolean().nullable().optional(),
...
export const STAFF_POOL_FILTER_SCHEMA = z.object({
  ...
  canTravel: FILTER_BOOLEAN_SCHEMA.optional(),
